        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              ...
              frameworks, tools, and industry best practices to develop
              optimized, high-performance solutions that meet user needs and
          ...
          <div className="md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-inside text-gray-300 space-y-4">
                <li>
                  <strong>B.Tech in Information Technology</strong> (2021 -
                  2025) <br /> Rajkiya Engineering College, Bijnor <br />
                </li>
                <li>
